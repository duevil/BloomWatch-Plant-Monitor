...
#ifndef PROTOTYPE_DEBUG_H
#define PROTOTYPE_DEBUG_H
 ...
 */
int64_t debug_millis(int64_t offset = 0) {
    static int64_t t_offset{offset};
    return esp_timer_get_time() / 1000LL - t_offset;
}

#ifdef DISABLE_RAPID_RESTART_PREVENTION
/**
...
#define DEBUG_BLYNK_EVENT(msg) { \
    Blynk.logEvent("debug", msg); \
} while (0)
...
#define DEBUG_BLYNK_EVENT(msg) (void)0

#endif

#endif //PROTOTYPE_DEBUG_H
